...
Use this before pushing or accepting a production change for SlotsFreeUSA.

## Before changing files

- Read `STABILITY-DIRECTIVE.md`.
- Read `PROJECT-STATUS.md` if present.
- Read `QA-CHECKLIST.md`.
...
- Confirm legal, disclosure, and responsible-play pages still exist.
...
Test the homepage, main navigation, public guide pages, legal/disclosure pages, footer links, and mobile layout.
...
- disclosure and responsible-play pages remain available
